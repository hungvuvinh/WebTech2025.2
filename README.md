...
- **`frontend/`**: Vite + React + shadcn/ui + Sonner + Lucide. **Dev mới đọc [`frontend/README.md`](frontend/README.md)** và backlog [`frontend/TODO.md`](frontend/TODO.md).
...
Mở http://localhost:5173 — proxy `/api` → backend `:8080`.

| Tài liệu | Mục đích |
|----------|----------|
| [`frontend/README.md`](frontend/README.md) | Cấu trúc, quy tắc code, use-case ↔ route |
| [`frontend/TODO.md`](frontend/TODO.md) | Việc còn lại (P0–P3) |
| [`frontend/src/config/routes.js`](frontend/src/config/routes.js) | Bản đồ route + API |
| [`frontend/src/config/features.js`](frontend/src/config/features.js) | Trạng thái tính năng |
